...
docker login
docker tag day02-todo:latest username/new-reponame:tagname(vyshnavi2119/test-repo:latest)
docker images
...
docker run -dp 3000:3000 username/new-reponame:tagname(vyshnavi2119/test-repo:latest)
